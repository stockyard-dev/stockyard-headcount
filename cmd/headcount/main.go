...
import (
	...
	"github.com/stockyard-dev/stockyard-headcount/internal/license"
...
func main() {
	...
	licenseKey := os.Getenv("HEADCOUNT_LICENSE_KEY")
	...
	log.Printf("Stockyard Headcount listening on :%s (tier: %s)", port, tier)
